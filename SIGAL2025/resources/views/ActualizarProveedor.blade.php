...
@section('title', 'Actualizar Proveedor - SIGAL')

@section('content')
<section class="bg-white dark:bg-gray-900">
  <div class="py-4 px-4 mx-auto max-w-7xl lg:py-8">
      <h1 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">ACTUALIZAR PROVEEDOR</h1>
       <form id="actualizarProveedorForm" action="{{ route('proveedores.actualizar', $proveedor['COD_PROVEEDORES'] ?? '') }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')

        <!-- Campo oculto para COD_PROVEEDOR -->
        <input type="hidden" name="COD_PROVEEDORES" value="{{ $proveedor['COD_PROVEEDORES'] ?? '' }}">
        ...
        <div class="w-full">
                  ...
                  <input type="text" name="NOMBRE_PROVEEDOR" id="NOMBRE_PROVEEDOR" value="{{ $proveedor['NOMBRE_EMPRESA'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre del proveedor" required maxlength="40" minlength="3">
              </div>
            <div class="w-full">
                <label for="NOMBRE_CONTACTO" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nombre Contacto</label>
                <input type="text" id="NOMBRE_CONTACTO" name="NOMBRE_CONTACTO" value="{{ $proveedor['NOMBRE_CONTACTO'] ?? '' }}"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre Contacto" required maxlength="30" minlength="3">
            </div>
                <div class="w-full">
                <label for="APELLIDO_CONTACTO" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Apellido Contacto</label>
                <input type="text" id="APELLIDO_CONTACTO" name="APELLIDO_CONTACTO" value="{{ $proveedor['APELLIDO_CONTACTO'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Apellido Contacto" required maxlength="30" minlength="3">
            </div>
            ...
            <div class="w-full">
                ...
                <input type="text" id="NUMERO_IDENTIDAD" name="NUMERO_IDENTIDAD" value="{{ $proveedor['NUMERO_IDENTIDAD'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="0000-0000-00000" required maxlength="15" minlength="15" pattern="\d{4}-\d{4}-\d{5}" title="El formato debe ser 0000-0000-00000" oninput="formatearIdentidad(this)">
                </div>
                <div class="w-full">
                <label for="RTN" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">RTN</label>
                <input type="text" id="RTN" name="RTN" value="{{ $proveedor['RTN'] ?? '' }}"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="0000-0000-000000" required maxlength="16" minlength="16" pattern="\d{4}-\d{4}-\d{6}" title="El formato debe ser 0000-0000-000000" oninput="formatearRTN(this)">
            </div>
            <div class="w-full">
                <label for="CALLE" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Calle</label>
                <input type="text" id="CALLE" name="CALLE" value="{{ $proveedor['CALLE'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Calle" required maxlength="60">
                </div>
                <div class="w-full">
                <label for="CIUDAD" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ciudad</label>
                <input type="text" id="CIUDAD" name="CIUDAD" value="{{ $proveedor['CIUDAD'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ciudad" required maxlength="30">
                </div>
                <div class="w-full">
                <label for="PAIS" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">País</label>
                <input type="text" id="PAIS" name="PAIS" value="{{ $proveedor['PAIS'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="País" required maxlength="20">
                </div>
                <div class="w-full">
                <label for="CODIGO_POSTAL" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Código Postal</label>
                <input type="text" id="CODIGO_POSTAL" name="CODIGO_POSTAL" value="{{ $proveedor['CODIGO_POSTAL'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Código Postal" required maxlength="7">
                </div>

            <div class="w-full">
                <label for="TELEFONO" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Número de Teléfono</label>
                <input type="text" id="TELEFONO" name="TELEFONO" value="{{ $proveedor['NUMERO_TELEFONO'] ?? '' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="0000-0000" required maxlength="10" minlength="10" pattern="\d{4}-\d{4}" oninput="formatearTelefono(this)">
            </div>
                <div class="w-full">
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('proveedores.listar') }}" class="text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white font-medium rounded-lg text-sm px-5 py-2.5">Cancelar</a>
            <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-800">Actualizar Proveedor</button>
        </div>
    </form>
</div>
<script>
       ...
       function formatearTelefono(input) {
        ...
        document.getElementById("actualizarProveedorForm").addEventListener("submit", function (event) {
